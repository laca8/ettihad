...
export const addLecture = createAsyncThunk("addLecture", async (row:lecture, api) => {
  try {
...
export const fetchLectures = createAsyncThunk("fetchLectures", async (keyword:{code:string}, api) => {
    try {
...
export const removeLecture = createAsyncThunk("removeLecture", async (id:string, api) => {
  try {
...
export const editLecture = createAsyncThunk("editLecture", async (row:obj, api) => {
  try {
